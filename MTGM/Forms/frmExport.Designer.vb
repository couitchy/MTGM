...
Partial Class frmExport
    ...
    Private Sub InitializeComponent()
        ...
        Me.cboFormat.Items.AddRange(New Object() {"MTGM v2 (*.dk2)", "MTGM (*.dck)", "MTG Arena (*.txt)", "Apprentice / ManaStack (*.dec)", "Magic Workstation (*.mwDeck)", "Urza Gatherer (*.ugs)", "Site Web (*.html)"})
        ...
        'dlgFileBrowser
        '
        Me.dlgFileBrowser.Filter = "Fichiers MTGM v2 (*.dk2) | *.dk2|Fichiers MTGM (*.dck) | *.dck|Fichiers Magic Master (*.xml) | *.xml|Fichiers Magic Workstation (*.mwDeck) | *.mwDeck|Fichiers Magic Collection (*.txt) | *.txt|Fichiers Magic Online (*.csv) | *.csv|Fichiers XMage (*.dck) | *.dck|Fichiers Urza Gatherer (*.ugs) | *.ugs|Fichiers Urza Gatherer (*.csv) | *.csv|Fichiers MTG Arena (*.txt) | *.txt"
