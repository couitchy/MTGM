...
Public Partial Class frmExport
    ...
    Dim VpReserveNotif As Boolean = False
        'En-tête
        Select Case VmFormat
            Case mdlConstGlob.eFormat.Apprentice
                ...
                VpOut.WriteLine("// FORMAT:  Classic")
        ...
        With VgDBReader
            While .Read
                Select Case VmFormat
                    Case mdlConstGlob.eFormat.Apprentice
                        If Not VpIsCollection AndAlso Not VpReserveNotif AndAlso .GetBoolean(8) Then
                            VpOut.WriteLine("Sideboard:")
                            VpReserveNotif = True
                        End If
