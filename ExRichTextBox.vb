...
Public Class ExRichTextBox
	...
	Private Enum EmfToWmfBitsFlags
		...
		' Embed the source of the EMF metafile within the resulting WMF
		' metafile
	...
	Private Class RtfFontFamilyDef
	...
	Private m_textColor As eRtfColor

	' The default text background color
	Private highlightColor As eRtfColor
...
'		 * 
	...
	Public Property TextColor() As eRtfColor
		Get
			Return m_textColor
		End Get
		Set
	...
	Public Property HiglightColor() As eRtfColor
		Get
	...
	Public Sub New()
		...
		m_textColor = eRtfColor.Black
		highlightColor = eRtfColor.White

		' Initialize the dictionary mapping color codes to definitions
		rtfColor = New HybridDictionary()
		rtfColor.Add(eRtfColor.Aqua, RtfColorDef.Aqua)
		rtfColor.Add(eRtfColor.Black, RtfColorDef.Black)
		rtfColor.Add(eRtfColor.Blue, RtfColorDef.Blue)
		rtfColor.Add(eRtfColor.Fuchsia, RtfColorDef.Fuchsia)
		rtfColor.Add(eRtfColor.Gray, RtfColorDef.Gray)
		rtfColor.Add(eRtfColor.Green, RtfColorDef.Green)
		rtfColor.Add(eRtfColor.Lime, RtfColorDef.Lime)
		rtfColor.Add(eRtfColor.Maroon, RtfColorDef.Maroon)
		rtfColor.Add(eRtfColor.Navy, RtfColorDef.Navy)
		rtfColor.Add(eRtfColor.Olive, RtfColorDef.Olive)
		rtfColor.Add(eRtfColor.Purple, RtfColorDef.Purple)
		rtfColor.Add(eRtfColor.Red, RtfColorDef.Red)
		rtfColor.Add(eRtfColor.Silver, RtfColorDef.Silver)
		rtfColor.Add(eRtfColor.Teal, RtfColorDef.Teal)
		rtfColor.Add(eRtfColor.White, RtfColorDef.White)
		rtfColor.Add(eRtfColor.Yellow, RtfColorDef.Yellow)
	...
	Public Sub New(_textColor As eRtfColor)
		Me.New()
	...
	Public Sub New(_textColor As eRtfColor, _highlightColor As eRtfColor)
		Me.New()
		m_textColor = _textColor
	...
	Public Sub AppendTextAsRtf(_text As String, _font As Font, _textColor As eRtfColor)
	...
	Public Sub AppendTextAsRtf(_text As String, _font As Font, _textColor As eRtfColor, _backColor As eRtfColor)
	...
	''' <param name="_font"></param>
	''' <param name="_color"></param>
	Public Sub InsertTextAsRtf(_text As String, _font As Font, _textColor As eRtfColor)
	...
	''' <param name="_color"></param>
	''' <param name="_color"></param>
	Public Sub InsertTextAsRtf(_text As String, _font As Font, _textColor As eRtfColor, _backColor As eRtfColor)
...
'			End If
	...
	''' <param name="_backColor"></param>
	''' <returns></returns>
	Private Function GetColorTable(_textColor As eRtfColor, _backColor As eRtfColor) As String
