...
Public Partial Class frmAddCards
	...
	Dim VpO As Object
		...
		VgDBCommand.CommandText = "Select Items From " + IIf(Me.mnuDropToCollection.Checked, clsModule.CgSCollection, clsModule.CgSDecks) + " Where EncNbr = " + VpEncNbr + IIf(Me.mnuDropToCollection.Checked = False, " And GameID = " + Me.cmdDestination.Tag.ToString + ";", ";")
	...
	Public Sub New(VpOwner As MainForm)
		...
		If VgOptions.GetDeckCount = 0 Then
			Me.cmdDestination.Visible = False
		Else
			'Destinations possibles
			For VpI As Integer = 1 To VgOptions.GetDeckCount
				Me.cmnuDestination.Items.Add(VgOptions.GetDeckName(VpI), Nothing, AddressOf DropTo)
			Next VpI
		End If
		'Destination par défaut
		For Each VpItem1 As Object In VpOwner.mnuDisp.Items
			If VpItem1.Checked Then
				For Each VpItem2 As ToolStripMenuItem In Me.cmnuDestination.Items
					If VpItem1.Text = VpItem2.Text Then
						VpItem2.Checked = True
						Me.cmdDestination.Tag = Me.cmnuDestination.Items.IndexOf(VpItem2) - 1
						Exit For
					End If
				Next VpItem2
				Exit For
	...
	Sub DropTo(ByVal sender As Object, ByVal e As EventArgs)
		...
		Next VpItem
		Me.cmdDestination.Tag = Me.cmnuDestination.Items.IndexOf(sender) - 1
	...
	Sub CBarAjoutMouseMove(ByVal sender As Object, ByVal e As MouseEventArgs)
		...
		End If		
	End Sub	
	Sub CmdFinClick(ByVal sender As Object, ByVal e As EventArgs)
		Me.Close
	...
	Sub CmdAddClick(ByVal sender As Object, ByVal e As EventArgs)
		Try
			If CInt(Me.lblNbItems.Text) = 0 Then
			...
			ElseIf ( CInt(Me.lblNbItems.Text) + CInt(Me.txtNbItems.Text) ) <= 0 Then
				...
				VgDBCommand.ExecuteNonQuery			
			Else
				VgDBCommand.CommandText = "Update " + IIf(Me.mnuDropToCollection.Checked, clsModule.CgSCollection, clsModule.CgSDecks) + " Set Items = " + (CInt(Me.lblNbItems.Text) + CInt(Me.txtNbItems.Text)).ToString + " Where EncNbr = " + Me.lblEncNbr.Text + IIf(Me.mnuDropToCollection.Checked = False, " And GameID = " + Me.cmdDestination.Tag.ToString, "") + ";"			
				VgDBCommand.ExecuteNonQuery
			End If		
			Me.cboTitleFR.Text = ""
			Me.cboTitleEN.Text = ""
